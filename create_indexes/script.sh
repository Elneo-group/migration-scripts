...
echo "divers.sql..."
psql -h $DB_HOST -d $DATABASE -U $DB_USER -f $BASEDIR/get_indexes.sql > $BASEDIR/create_indexes.sql
sed -i '$d' $BASEDIR/create_indexes.sql
sed -i '$d' $BASEDIR/create_indexes.sql
psql -h $DB_HOST -d $DATABASE -U $DB_USER -f $BASEDIR/create_indexes.sql
